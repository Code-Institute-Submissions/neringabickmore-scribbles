...
def search_discover():
    ...
    return render_template(
        "pages/discover.html", reviews=reviews)
...
def user_reviews():
    ...
    if session["user"]:
        ...
        reviews = list(MONGO.db.reviews.find(
            {"reviewed_by": session["user"]}))
        return render_template(
            "pages/my-reviews.html", user=user_profile,
            reviews=reviews)
    return redirect(url_for("user_reviews"))
...
def profile():
    ...
    if session["user"]:
        ...
        return render_template(
            "pages/profile.html", user=user_profile)
...
def edit_profile(user_profile_id):
    ...
    return render_template(
        "pages/profile.html", main_content="edit_profile",
        user=user_profile)
